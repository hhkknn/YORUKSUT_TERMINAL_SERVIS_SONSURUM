...
{
    public class AddOrUpdateDeliveryNotes
    {

        public Response addOrUpdateDeliveryNotes(string dbName, int kullaniciId,DeliveryNotesReturns deliveryNotesReturns)
        {
            ...
            try
            {
                ...
                int i = 0;
                foreach (var item in deliveryNotesReturns.DeliveryNotesReturnDetails)
                {
